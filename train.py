...
DATASET_ROOT = '/mnt/lustre/share/platform/dataset/CASIA/'
...
parser.add_argument('--root-path', type=str, default= DATASET_ROOT + 'webface_align_112', help='the training set root path')
parser.add_argument('--image-list', type=str, default='/mnt/lustre/share/platform/dataset/CASIA/webface_align_112_list.txt', help='the file and its path of image list')
...
def train(train_loader, model, MCP, criterion, optimizer, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader, 1):
        ...
        output = model(data)
        # pdb.set_trace()
        output = MCP(output, target).requires_grad_()
